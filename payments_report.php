                ...
                <div class="col-md-12">
                    <table class="table table-bordered" id='report-list'>
                        ...
                        <tbody>
                            ...
                            $i = 1;
                            $total = 0;
                            $payments = $conn->query("SELECT p.*,s.name as sname, ef.ef_no,s.reg_no FROM payments p inner join studentfees ef on ef.id = p.ef_id inner join student s on s.id = ef.student_id where date_format(p.date_created,'%Y-%m') = '$month' order by unix_timestamp(p.date_created) asc ");
